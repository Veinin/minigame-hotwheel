...
namespace Game.Core.Timer
{
    ...
    public class Timer
    {
        ...
        public static Timer Register(float duration, Action onComplete, bool isLooped = false, bool useRealTime = false,
        ...
        /// scene manually.
        /// </summary>
        private class TimerManager : SingletonObject<TimerManager>
        {
