...
public static class TimerExtensions
{
    ...
    public static Timer RegisterTimer(this MonoBehaviour behaviour, float duration, Action onComplete,
        bool isLooped = false, Action<float> onUpdate = null, bool useRealTime = false)
    {
        return Timer.Register(duration, onComplete, isLooped, useRealTime, onUpdate, behaviour);
    }
}